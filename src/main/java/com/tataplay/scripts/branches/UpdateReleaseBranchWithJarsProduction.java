...
public class UpdateReleaseBranchWithJarsProduction {
    ...
    private static final String RELEASE_BRANCH_NAME = "release-25-11-2025-E";
    ...
    static {
        jars.put("common-pojo", "16.4.3");
        jars.put("common-constants", "14.20.2");
        jars.put("common-sql-domains", "14.7.7");
        jars.put("common-event-domains", "1.9.5");
        jars.put("subscriber-db-util", "7.5.8");
        jars.put("homescreen-db-util", "10.0.2");
        jars.put("cache", "13.3.4");
        jars.put("content-db-util", "8.6.0");
        jars.put("mm-domains", "8.3.8");
        jars.put("tatasky-sms-connector", "8.7.4");
        jars.put("pubnub-router-client", "1.4.5");
//        jars.put("third-party-utils", "2.7.6");
//        jars.put("module-config", "5.0.6");
//        jars.put("common-db-tsf", "2.4.4");
